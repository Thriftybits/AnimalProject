...
app.post('/animals', (req, res) => {
    ...
    const sql = `INSERT INTO tblAnimals (id, type, name, breed, sex, birthdate, weight, size, animalId, location, description, notes, vetName, visitType, visitNotes, feedingTime, feedingAmount, feedingWhat, photo) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`;
...
app.put('/animals', (req, res) => {
    ...
    const sql = `UPDATE tblAnimals SET type=?, name=?, breed=?, sex=?, birthdate=?, weight=?, size=?, animalId=?, location=?, description=?, notes=?, vetName=?, visitType=?, visitNotes=?, feedingTime=?, feedingAmount=?, feedingWhat=?, photo=? WHERE id=?`;
